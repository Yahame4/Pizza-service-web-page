...
class KundenStatus extends Page
{
    ...
    protected function getViewData():array
    {
        ...
        //Warning bei nicht vorhandene Sessions
        if (!isset($_SESSION['orderid'])) {
            throw new Exception("Error: Es wurde keine Bestellung von ihnen gefunden!");
        }
        ...
        //Warning bei nicht vorhandene Pizzen
        if (!$recordset) {
        ...
        foreach($data as $pizza) {
            array_push($pizzalist, array_combine($key, $pizza));
        }
    ...
    protected function generateView():void
    {
        ...
        $serializedData = json_encode($data); //Serialisierung der Objekte nach JSON
        echo $serializedData;
    ...
    //leere Funktion aufgrund von diesmal nicht benoetigte Formulardaten Empfangung
    }
