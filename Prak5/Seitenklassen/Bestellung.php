    ...
    protected function generateView(): void
    {
        ...
        foreach($data as $pizza) {
            ...
            echo <<<HTML
                ...
                <p class="pizzaName">{$pizzaName} : {$price} €</p> 
                </div>
            HTML;
        }
        ...
        <section class="Warenkorb">
            ...
            <form action="./Bestellung.php" method="POST" onsubmit="return orderForm();">
                <select class="PizzaSelect" name="pizza[]" id="pizza" tabindex="1"  multiple>
                </select>
                ...
                <button class="deleteBtn" tabindex="2" accesskey="a" onclick="shoppingcart.deleteAll();" >Alle Löschen</button>
                <button class="deleteBtn" tabindex="3" accesskey="s" onclick="shoppingcart.deleteSelected();" >Auswahl Löschen</button>
                <button class="submitBtn" type="submit" tabindex="4" accesskey="b" id="submit" onclick="onSubmit();" disabled="disabled">Bestellen</button>
            </form>
            <div class="Seperator"></div>
        </section>
        HTML;
