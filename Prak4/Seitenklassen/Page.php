...
abstract class Page
{
    ...
    protected function generatePageHeader(string $title = "", string $jsFile = "", bool $autoreload = false): void
    {
        ...
        <header>
            <h1>Pizzaservice</h1>
            <a href="/Praktikum/Prak4/Seitenklassen/Bestellung.php">Bestellung</a>
            <a href="/Praktikum/Prak4/Seitenklassen/Baecker.php">Bäcker</a>
            <a href="/Praktikum/Prak4/Seitenklassen/Fahrer.php">Fahrer</a>
            <a href="/Praktikum/Prak4/Seitenklassen/Kunde.php">Kunde</a>
        </header>
        <br>
        HTML;
